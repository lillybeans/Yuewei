      ...
      <div id="login-content">
        ...
        <form action='core/login.php' method=post>
          <fieldset id="inputs">
            ...
            <center>
            <a href=login.php><input id="submit" type="submit" value="登陆"></a><a class=fade_link href=register.php target=iframe><input id="register" type=button value="注册"></a></center>
